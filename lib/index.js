...
var __vue_render__ = function() {
  ...
  return _c(
    "div",
    _vm._g(
      _vm._b({ staticClass: "btb-vue-table" }, "div", _vm.$attrs, false),
      _vm.$listeners
    ),
    [
      _c(
        "table",
        {
          class: [
            "table_container",
            { "container-x-scrollable": _vm.xScrollable }
          ],
          ...
          _vm.bodyData.length
            ? [
                _c(
                  ...
                  [
                    _vm._l(_vm.bodyData, function(entry_tr) {
                      return [
                        _c(
                          "tr",
                          {
                            key: entry_tr.index,
                            class: ["body_tr", "tr-" + entry_tr.index]
                          },
                          [
                            _vm._l(_vm.headData, function(entry_td) {
                              return [
